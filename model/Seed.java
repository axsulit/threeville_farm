...
/**
 * The model.Seed class represents the different seeds that can be bought and planted by the farmer on the farm lot.
 */
public class Seed {
    /**
    ...
    /**
     * Initializes the attributes of the model.Seed class.
     *
